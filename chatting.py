    ...
    if msg:
        ...
        if state == "initial":
            if msg == '1':
                ...
                resp.message("يرجى إدخال الرقم باللغة الإنجليزية.")
        elif state == "master's_level":
            if msg == '1':
                user_previous_state[from_number] = state
            ...
            if msg == '1':
                resp.message("في حال الحصول على ضمان مالي باستطاعتك التقديم على طلب الابتعاث الالكتروني باتباع الخطوات التالية:\nأولا انجز:يجب تقديم طلب الابتعاث عن طريق منصة انجز اولا\nوارفاق مايلي:\n 1-موافقة القسم\n 2-موافقة الكلية\n 1-موافقة إدارة الابتعاث\n\nثانيا سفير:بعد الموافقة على الطلب من انجز يجب  فتح ملف في موقع سفير\nوارفاق مايلي:\n 1-قرار الإبتعاث\n 2-القبول الأكاديمي\n 1-الإرتباط المالي")
            ...
            if msg == '1':
                ...
                resp.message("\nالإجراءات اللازمة في حال عدم الحصول على درجة:\n"
                             "- تقديم طلب انهاء في منصة سفير (للابتعاث الخارجي فقط)\n"
                             "- تقديم طلب انهاء بعثة على النظام أنجز مع ارفاق المستندات التاليه لمبررات الإنهاء\n"
                             "\t- رفع بدل الطباعة\n"
                             "\t- مستند بدل الطباعة\n"
